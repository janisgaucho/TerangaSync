...
export default function GestionnaireDashboard({ profile, user, onRegionClick }) {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        <h1 className="text-3xl font-bold text-gray-900">
          Bienvenue, {profile.prenom || 'Utilisateur'}
        </h1>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        {loadingRegions ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {regions.map((region) => (
              <button key={region.id} onClick={() => onRegionClick(region.id)} className="bg-green-50 border border-green-200 text-green-800 rounded-lg p-3 text-center hover:bg-green-100 hover:border-green-300 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500">
